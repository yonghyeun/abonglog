...
const ExampleComponent = () => {
  return (
    <div>
      <SeriesItem seriesName="React Basics" numOfArticles={10} updatedAt="2025-03-05" />
      <SeriesItem seriesName="Advanced TypeScript" numOfArticles={5} updatedAt="2025-02-28" />
    </div>
  );
};
\`\`\`
