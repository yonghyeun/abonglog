...
export const SeriesItem: React.FC<SeriesItemProps> = ({
  ...
  return (
    <div className="transtion-all flex flex-grow transform flex-col gap-2 rounded-lg border border-gray-200 bg-primary p-4 transition-transform duration-200 hover:scale-105">
