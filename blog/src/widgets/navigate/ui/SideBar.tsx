...
export const SideBar = () => {
  ...
  return (
    <>
      {/* 사이드바 햄버거 */}
      <button
        className="flex flex-col gap-1 rounded-lg p-2 text-primary hover:bg-secondary focus:outline-none focus:ring focus:ring-brand-primary active:bg-secondary"
        aria-label="메뉴 열기"
        tabIndex={0}
        ...
        <div>
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <button
              ...
              aria-label="메뉴 닫기"
              className="p-2 text-primary hover:bg-gray-200 focus:outline-none focus:ring focus:ring-brand-primary active:bg-gray-200"
            >
