...
export const SideBar = () => {
  ...
  return (
    <>
      ...
      {/* 사이드바 컴포넌트 */}
      <aside
        className={`absolute left-0 top-0 min-h-80 min-w-96 px-2 py-4 ${isOpen ? "" : "-translate-x-full"} z-50 rounded-xl bg-primary shadow-md transition-transform duration-300`}
        ref={sideBarRef}
      >
        {/* 사이드바 헤더 */}
